...
legend(x=900, y=0.19, lwd=3, lty="dashed", legend=c("Logistic regression fit"), bty="n")
...
mtext(4, at=0.082, text=("Genome\nAverage"), las=1, line=-1)
mtext(3, at=c(1,1.2,4,4.2), text="*", cex=2, line=-4)
